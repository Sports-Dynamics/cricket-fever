...
var CricketPlayerTableColumns = struct {
	...
	JoiningDate:       "cricket_players.joining_date",
	TeamID:            "cricket_players.team_id",
	CreatedAt:         "cricket_players.created_at",
	UpdatedAt:         "cricket_players.updated_at",
}
...
var CricketPlayerWhere = struct {
	...
	JoiningDate:       whereHelpertime_Time{field: "\"cricket_players\".\"joining_date\""},
	TeamID:            whereHelperint{field: "\"cricket_players\".\"team_id\""},
	CreatedAt:         whereHelpernull_Time{field: "\"cricket_players\".\"created_at\""},
	UpdatedAt:         whereHelpernull_Time{field: "\"cricket_players\".\"updated_at\""},
}

// CricketPlayerRels is where relationship names are stored.
var CricketPlayerRels = struct {
	Team                 string
	PlayerGroundBookings string
	PlayerTeamPlayers    string
}{
	Team:                 "Team",
	PlayerGroundBookings: "PlayerGroundBookings",
...
type cricketPlayerR struct {
	...
	PlayerGroundBookings GroundBookingSlice `boil:"PlayerGroundBookings" json:"PlayerGroundBookings" toml:"PlayerGroundBookings" yaml:"PlayerGroundBookings"`
...
func (r *cricketPlayerR) GetTeam() *CricketTeam {
	if r == nil {
		return nil
	}
	return r.Team
...
func (r *cricketPlayerR) GetPlayerGroundBookings() GroundBookingSlice {
	if r == nil {
		return nil
	}
	return r.PlayerGroundBookings
}
...
var (
	cricketPlayerAllColumns            = []string{"player_id", "player_uuid", "player_name", "player_email", "player_mobile", "player_picture", "player_role", "batting_positions", "bowler_types", "fielding_positions", "joining_date", "team_id", "created_at", "updated_at"}
	cricketPlayerColumnsWithoutDefault = []string{"player_uuid", "player_name", "player_email", "player_mobile", "player_role", "batting_positions", "bowler_types", "fielding_positions", "team_id"}
	cricketPlayerColumnsWithDefault    = []string{"player_id", "player_picture", "joining_date", "created_at", "updated_at"}
...
func (o *CricketPlayer) Team(mods ...qm.QueryMod) cricketTeamQuery {
...
// PlayerGroundBookings retrieves all the ground_booking's GroundBookings with an executor via player_id column.
func (o *CricketPlayer) PlayerGroundBookings(mods ...qm.QueryMod) groundBookingQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"ground_bookings\".\"player_id\"=?", o.PlayerID),
	)
...
func (cricketPlayerL) LoadTeam(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCricketPlayer interface{}, mods queries.Applicator) error {
	...
	if singular {
		...
		foreign.R.TeamCricketPlayers = append(foreign.R.TeamCricketPlayers, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.TeamID == foreign.TeamID {
				...
				foreign.R.TeamCricketPlayers = append(foreign.R.TeamCricketPlayers, local)
				break
			}
		}
	}
...
// LoadPlayerGroundBookings allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (cricketPlayerL) LoadPlayerGroundBookings(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCricketPlayer interface{}, mods queries.Applicator) error {
	var slice []*CricketPlayer
	var object *CricketPlayer
	...
	query := NewQuery(
		...
		qm.WhereIn(`ground_bookings.player_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.PlayerGroundBookings = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if queries.Equal(local.PlayerID, foreign.PlayerID) {
				local.R.PlayerGroundBookings = append(local.R.PlayerGroundBookings, foreign)
				if foreign.R == nil {
					foreign.R = &groundBookingR{}
				}
...
// SetTeamG of the cricketPlayer to the related item.
// Sets o.R.Team to related.
// Adds o to related.R.TeamCricketPlayers.
// Uses the global database handle.
func (o *CricketPlayer) SetTeamG(ctx context.Context, insert bool, related *CricketTeam) error {
	return o.SetTeam(ctx, boil.GetContextDB(), insert, related)
}

// SetTeam of the cricketPlayer to the related item.
// Sets o.R.Team to related.
// Adds o to related.R.TeamCricketPlayers.
func (o *CricketPlayer) SetTeam(ctx context.Context, exec boil.ContextExecutor, insert bool, related *CricketTeam) error {
	var err error
	if insert {
	...
	values := []interface{}{related.TeamID, o.PlayerID}
	...
	if related.R == nil {
		related.R = &cricketTeamR{
			TeamCricketPlayers: CricketPlayerSlice{o},
		}
	} else {
		related.R.TeamCricketPlayers = append(related.R.TeamCricketPlayers, o)
	}

	return nil
}

// AddPlayerGroundBookingsG adds the given related objects to the existing relationships
// of the cricket_player, optionally inserting them as new records.
// Appends related to o.R.PlayerGroundBookings.
// Sets related.R.Player appropriately.
// Uses the global database handle.
func (o *CricketPlayer) AddPlayerGroundBookingsG(ctx context.Context, insert bool, related ...*GroundBooking) error {
	return o.AddPlayerGroundBookings(ctx, boil.GetContextDB(), insert, related...)
}

// AddPlayerGroundBookings adds the given related objects to the existing relationships
// of the cricket_player, optionally inserting them as new records.
// Appends related to o.R.PlayerGroundBookings.
// Sets related.R.Player appropriately.
func (o *CricketPlayer) AddPlayerGroundBookings(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*GroundBooking) error {
	var err error
	for _, rel := range related {
		if insert {
			queries.Assign(&rel.PlayerID, o.PlayerID)
			...
			values := []interface{}{o.PlayerID, rel.BookingID}
	...
	if o.R == nil {
		o.R = &cricketPlayerR{
			PlayerGroundBookings: related,
		}
	} else {
		o.R.PlayerGroundBookings = append(o.R.PlayerGroundBookings, related...)
	}
...
// SetPlayerGroundBookingsG removes all previously related items of the
// cricket_player replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Player's PlayerGroundBookings accordingly.
// Replaces o.R.PlayerGroundBookings with related.
// Sets related.R.Player's PlayerGroundBookings accordingly.
// Uses the global database handle.
func (o *CricketPlayer) SetPlayerGroundBookingsG(ctx context.Context, insert bool, related ...*GroundBooking) error {
	return o.SetPlayerGroundBookings(ctx, boil.GetContextDB(), insert, related...)
}

// SetPlayerGroundBookings removes all previously related items of the
// cricket_player replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Player's PlayerGroundBookings accordingly.
// Replaces o.R.PlayerGroundBookings with related.
// Sets related.R.Player's PlayerGroundBookings accordingly.
func (o *CricketPlayer) SetPlayerGroundBookings(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*GroundBooking) error {
	query := "update \"ground_bookings\" set \"player_id\" = null where \"player_id\" = $1"
	values := []interface{}{o.PlayerID}
	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
	...
	if o.R != nil {
		for _, rel := range o.R.PlayerGroundBookings {
		...
		o.R.PlayerGroundBookings = nil
	}

	return o.AddPlayerGroundBookings(ctx, exec, insert, related...)
}

// RemovePlayerGroundBookingsG relationships from objects passed in.
// Removes related items from R.PlayerGroundBookings (uses pointer comparison, removal does not keep order)
// Sets related.R.Player.
// Uses the global database handle.
func (o *CricketPlayer) RemovePlayerGroundBookingsG(ctx context.Context, related ...*GroundBooking) error {
	return o.RemovePlayerGroundBookings(ctx, boil.GetContextDB(), related...)
}

// RemovePlayerGroundBookings relationships from objects passed in.
// Removes related items from R.PlayerGroundBookings (uses pointer comparison, removal does not keep order)
// Sets related.R.Player.
func (o *CricketPlayer) RemovePlayerGroundBookings(ctx context.Context, exec boil.ContextExecutor, related ...*GroundBooking) error {
	if len(related) == 0 {
		return nil
	}
	...
	for _, rel := range related {
		for i, ri := range o.R.PlayerGroundBookings {
			if rel != ri {
				continue
			}

			ln := len(o.R.PlayerGroundBookings)
			if ln > 1 && i < ln-1 {
				o.R.PlayerGroundBookings[i] = o.R.PlayerGroundBookings[ln-1]
			}
			o.R.PlayerGroundBookings = o.R.PlayerGroundBookings[:ln-1]
			break
		}
	}
