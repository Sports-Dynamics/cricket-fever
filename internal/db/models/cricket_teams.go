...
var CricketTeamTableColumns = struct {
	...
	CreatedAt:     "cricket_teams.created_at",
	UpdatedAt:     "cricket_teams.updated_at",
}
...
var CricketTeamWhere = struct {
	...
	TeamCountry:   whereHelpernull_String{field: "\"cricket_teams\".\"team_country\""},
	TeamState:     whereHelpernull_String{field: "\"cricket_teams\".\"team_state\""},
	TeamCity:      whereHelpernull_String{field: "\"cricket_teams\".\"team_city\""},
	...
	CreatedAt:     whereHelpernull_Time{field: "\"cricket_teams\".\"created_at\""},
	UpdatedAt:     whereHelpernull_Time{field: "\"cricket_teams\".\"updated_at\""},
}

// CricketTeamRels is where relationship names are stored.
var CricketTeamRels = struct {
	TeamCricketPlayers string
	TeamGroundBookings string
	TeamTeamPlayers    string
}{
	TeamCricketPlayers: "TeamCricketPlayers",
	TeamGroundBookings: "TeamGroundBookings",
	TeamTeamPlayers:    "TeamTeamPlayers",
}

// cricketTeamR is where relationships are stored.
type cricketTeamR struct {
	TeamCricketPlayers CricketPlayerSlice `boil:"TeamCricketPlayers" json:"TeamCricketPlayers" toml:"TeamCricketPlayers" yaml:"TeamCricketPlayers"`
	TeamGroundBookings GroundBookingSlice `boil:"TeamGroundBookings" json:"TeamGroundBookings" toml:"TeamGroundBookings" yaml:"TeamGroundBookings"`
...
func (r *cricketTeamR) GetTeamCricketPlayers() CricketPlayerSlice {
	if r == nil {
		return nil
	}
	return r.TeamCricketPlayers
}

func (r *cricketTeamR) GetTeamGroundBookings() GroundBookingSlice {
	if r == nil {
		return nil
	}
	return r.TeamGroundBookings
}
...
var (
	cricketTeamAllColumns            = []string{"team_id", "team_uuid", "team_name", "team_country", "team_state", "team_city", "captain_id", "vice_captain_id", "team_coach_id", "created_at", "updated_at"}
	cricketTeamColumnsWithoutDefault = []string{"team_name"}
	cricketTeamColumnsWithDefault    = []string{"team_id", "team_uuid", "team_country", "team_state", "team_city", "captain_id", "vice_captain_id", "team_coach_id", "created_at", "updated_at"}
...
// TeamCricketPlayers retrieves all the cricket_player's CricketPlayers with an executor via team_id column.
func (o *CricketTeam) TeamCricketPlayers(mods ...qm.QueryMod) cricketPlayerQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"cricket_players\".\"team_id\"=?", o.TeamID),
	)

	return CricketPlayers(queryMods...)
}

// TeamGroundBookings retrieves all the ground_booking's GroundBookings with an executor via team_id column.
func (o *CricketTeam) TeamGroundBookings(mods ...qm.QueryMod) groundBookingQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"ground_bookings\".\"team_id\"=?", o.TeamID),
	)
...
// LoadTeamCricketPlayers allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (cricketTeamL) LoadTeamCricketPlayers(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCricketTeam interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`cricket_players.team_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if err != nil {
		return errors.Wrap(err, "failed to eager load cricket_players")
	}

	var resultSlice []*CricketPlayer
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice cricket_players")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on cricket_players")
	}
	...
	if singular {
		object.R.TeamCricketPlayers = resultSlice
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.TeamID == foreign.TeamID {
				local.R.TeamCricketPlayers = append(local.R.TeamCricketPlayers, foreign)
				if foreign.R == nil {
					foreign.R = &cricketPlayerR{}
				}
...
// LoadTeamGroundBookings allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (cricketTeamL) LoadTeamGroundBookings(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCricketTeam interface{}, mods queries.Applicator) error {
	var slice []*CricketTeam
	var object *CricketTeam
	...
	query := NewQuery(
		...
		qm.WhereIn(`ground_bookings.team_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.TeamGroundBookings = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if queries.Equal(local.TeamID, foreign.TeamID) {
				local.R.TeamGroundBookings = append(local.R.TeamGroundBookings, foreign)
				if foreign.R == nil {
					foreign.R = &groundBookingR{}
				}
				foreign.R.Team = local
...
// AddTeamCricketPlayersG adds the given related objects to the existing relationships
// of the cricket_team, optionally inserting them as new records.
// Appends related to o.R.TeamCricketPlayers.
// Sets related.R.Team appropriately.
// Uses the global database handle.
func (o *CricketTeam) AddTeamCricketPlayersG(ctx context.Context, insert bool, related ...*CricketPlayer) error {
	return o.AddTeamCricketPlayers(ctx, boil.GetContextDB(), insert, related...)
}

// AddTeamCricketPlayers adds the given related objects to the existing relationships
// of the cricket_team, optionally inserting them as new records.
// Appends related to o.R.TeamCricketPlayers.
// Sets related.R.Team appropriately.
func (o *CricketTeam) AddTeamCricketPlayers(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*CricketPlayer) error {
	var err error
	for _, rel := range related {
		if insert {
			...
			updateQuery := fmt.Sprintf(
				"UPDATE \"cricket_players\" SET %s WHERE %s",
				strmangle.SetParamNames("\"", "\"", 1, []string{"team_id"}),
				strmangle.WhereClause("\"", "\"", 2, cricketPlayerPrimaryKeyColumns),
			)
			values := []interface{}{o.TeamID, rel.PlayerID}
	...
	if o.R == nil {
		o.R = &cricketTeamR{
			TeamCricketPlayers: related,
		}
	} else {
		o.R.TeamCricketPlayers = append(o.R.TeamCricketPlayers, related...)
	}

	for _, rel := range related {
		if rel.R == nil {
			rel.R = &cricketPlayerR{
				Team: o,
			}
		} else {
			rel.R.Team = o
...
// AddTeamGroundBookingsG adds the given related objects to the existing relationships
// of the cricket_team, optionally inserting them as new records.
// Appends related to o.R.TeamGroundBookings.
// Sets related.R.Team appropriately.
// Uses the global database handle.
func (o *CricketTeam) AddTeamGroundBookingsG(ctx context.Context, insert bool, related ...*GroundBooking) error {
	return o.AddTeamGroundBookings(ctx, boil.GetContextDB(), insert, related...)
}

// AddTeamGroundBookings adds the given related objects to the existing relationships
// of the cricket_team, optionally inserting them as new records.
// Appends related to o.R.TeamGroundBookings.
// Sets related.R.Team appropriately.
func (o *CricketTeam) AddTeamGroundBookings(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*GroundBooking) error {
	var err error
	for _, rel := range related {
		if insert {
			queries.Assign(&rel.TeamID, o.TeamID)
			if err = rel.Insert(ctx, exec, boil.Infer()); err != nil {
				return errors.Wrap(err, "failed to insert into foreign table")
			}
		} else {
			...
			values := []interface{}{o.TeamID, rel.BookingID}
	...
	if o.R == nil {
		o.R = &cricketTeamR{
			TeamGroundBookings: related,
		}
	} else {
		o.R.TeamGroundBookings = append(o.R.TeamGroundBookings, related...)
	}
...
// SetTeamGroundBookingsG removes all previously related items of the
// cricket_team replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Team's TeamGroundBookings accordingly.
// Replaces o.R.TeamGroundBookings with related.
// Sets related.R.Team's TeamGroundBookings accordingly.
// Uses the global database handle.
func (o *CricketTeam) SetTeamGroundBookingsG(ctx context.Context, insert bool, related ...*GroundBooking) error {
	return o.SetTeamGroundBookings(ctx, boil.GetContextDB(), insert, related...)
}

// SetTeamGroundBookings removes all previously related items of the
// cricket_team replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Team's TeamGroundBookings accordingly.
// Replaces o.R.TeamGroundBookings with related.
// Sets related.R.Team's TeamGroundBookings accordingly.
func (o *CricketTeam) SetTeamGroundBookings(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*GroundBooking) error {
	query := "update \"ground_bookings\" set \"team_id\" = null where \"team_id\" = $1"
	values := []interface{}{o.TeamID}
	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
	...
	if o.R != nil {
		for _, rel := range o.R.TeamGroundBookings {
		...
		o.R.TeamGroundBookings = nil
	}

	return o.AddTeamGroundBookings(ctx, exec, insert, related...)
}

// RemoveTeamGroundBookingsG relationships from objects passed in.
// Removes related items from R.TeamGroundBookings (uses pointer comparison, removal does not keep order)
// Sets related.R.Team.
// Uses the global database handle.
func (o *CricketTeam) RemoveTeamGroundBookingsG(ctx context.Context, related ...*GroundBooking) error {
	return o.RemoveTeamGroundBookings(ctx, boil.GetContextDB(), related...)
}

// RemoveTeamGroundBookings relationships from objects passed in.
// Removes related items from R.TeamGroundBookings (uses pointer comparison, removal does not keep order)
// Sets related.R.Team.
func (o *CricketTeam) RemoveTeamGroundBookings(ctx context.Context, exec boil.ContextExecutor, related ...*GroundBooking) error {
	if len(related) == 0 {
		return nil
	}
	...
	for _, rel := range related {
		for i, ri := range o.R.TeamGroundBookings {
			if rel != ri {
				continue
			}

			ln := len(o.R.TeamGroundBookings)
			if ln > 1 && i < ln-1 {
				o.R.TeamGroundBookings[i] = o.R.TeamGroundBookings[ln-1]
			}
			o.R.TeamGroundBookings = o.R.TeamGroundBookings[:ln-1]
			break
		}
	}
